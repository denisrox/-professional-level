...
public class Listener {
    static final Logger errorLogger = LogManager.getLogger(Main.class);
    ...
    public Listener() {
        ...
        try {
            ...
            infoLogger.info("Server started listening ");
            while (true) {
                socket = server.accept();
                infoLogger.info("the client is trying to log in");
            ...
            try {
                ...
                errorLogger.error("the client is trying to log in");
                e.printStackTrace();
            }
            try {
                server.close();
